...
const { day3Utils } = require("./script");

const day3 = day3Utils();
...
test('test [["R8","U5","L5","D3"],["U7","R6","D4","L4"]]', () => {
  ...
  expect(day3.intersectionClosestCalc(testProgram[0], testProgram[1])).toEqual(
    testProgramResult
  );
});
...
console.log(
  `Answer of day 3, part 1: ${day3.intersectionClosestCalc(
    locations[0],
    locations[1]
  )}`
);
